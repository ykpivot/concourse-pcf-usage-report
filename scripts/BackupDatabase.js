...
BackupDatabase.prototype.OUTPUT_DIR_NAME = "";
BackupDatabase.prototype.ORGS_USAGE_FILE = "";
BackupDatabase.prototype.reportTimeRangeObject = {};
BackupDatabase.prototype.pcfAppDomain = 'sys.lsilva01.c0.pivotal.io';
//BackupDatabase.prototype.pcfAppDmain = process.env.PCF_APPS_DOMAIN;
BackupDatabase.prototype.pcfApiEndPoint = process.env.PCF_API_ENDPOINT;
BackupDatabase.prototype.sysAdminUser = process.env.SYS_ADMIN_USER;
BackupDatabase.prototype.sysAdminPassword = process.env.SYS_ADMIN_PASSWORD;
BackupDatabase.prototype.pcfOrg = process.env.PCF_ORG;
BackupDatabase.prototype.pcfSpace = process.env.PCF_SPACE;

BackupDatabase.prototype.execute = function() {
  ...
  this.cfLogin();
  this.cfBackupDatabase();
};

BackupDatabase.prototype.cfLogin = function() {
...
BackupDatabase.prototype.cfBackupDatabase = function() {
