...
var emailText="PCF Usage report, deployment: "+process.env.PCF_DEPLOY_NAME+", period: from "+reportTimeRangeObject.USAGE_START_DATE+" to "+reportTimeRangeObject.USAGE_END_DATE;
